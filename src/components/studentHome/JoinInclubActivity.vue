<template>
  <div>
    ...
    <el-alert title="欢迎查看社团活动" type="info" center show-icon></el-alert>
    <br />
    ...
    <el-card class="box-card">
      ...
      <el-row :gutter="20">
        ...
        <el-row :gutter="20">
          <el-button type="primary" icon>社团活动</el-button>
      ...
      <el-table :data="activityList" :row-class-name="tableRowClassName">
        ...
        <el-table-column label="查看详情">
          <template slot-scope="scope">
            <el-button
              type="primary"
              @click="showActivitySummary(scope.row.activityId,scope.row.name,scope.row.place,scope.row.description,scope.row.eventTime,scope.row.clubName,'nb')"
            >查看</el-button>
          </template>
        </el-table-column>
    ...
    <!--        展示活动对话框-->
    <el-dialog title="活动详情" ref="showFormRef" :visible.sync="showDialogVisible" width="50%" center>
      <!--            展示内容主体区域 -->
      <el-form :model="addForm" label-width="150px">
        ...
        <el-form-item label="活动地点">
          <el-input v-model="addForm.place" readonly="true" style="width:82%;"></el-input>
        </el-form-item>
        ...
        <el-form-item label="活动时间">
          <el-input v-model="addForm.eventTime" readonly="true" style="width:82%;"></el-input>
        </el-form-item>
        <el-form-item label="所属社团">
          <el-input v-model="addForm.clubName" readonly="true" style="width:82%;"></el-input>
        </el-form-item>
    ...
    <!--        参加活动对话框-->
    <el-dialog title="提交申请" :visible.sync="addDialogVisible" width="50%">
      <!--            内容主体区域 放置一个表单-->
  ...
  methods: {
    ...
    async getActivityList() {
      let result = await this.$http.post(
        this.$api.StudentInActivitesInformationUrl,
        {
          query: this.query,
    ...
    async joinOneActivity(id) {
      let judge = await this.$http.post(
        this.$api.StudentJudgeJoinActivityUrl + "/" + id
      );
