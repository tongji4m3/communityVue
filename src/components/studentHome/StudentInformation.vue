<template>
  <div>
    ...
    <el-alert title="下方按钮可修改信息" type="info" center show-icon></el-alert>
    <br />
    ...
    <el-form :model="informationList[0]" ref="addFormRef" :rules="addFormRules" label-width="150px">
      <el-form-item label="姓名:" prop="name">
        <el-input
          v-model="informationList[0].name"
          readonly="true"
          :disabled="IsChange"
          size="medium"
          style="width:82%;"
      ...
      <el-form-item label="学号:" prop="number">
        <el-input
          v-model="informationList[0].number"
          readonly="true"
          :disabled="IsChange"
          size="medium"
          style="width:82%;"
      ...
      <el-form-item label="年级:" prop="grade">
        <el-input
          v-model="informationList[0].grade"
          readonly="true"
          :disabled="IsChange"
          size="medium"
          style="width:82%;"
      ...
      <el-form-item label="专业" prop="major">
        <el-input
          v-model="informationList[0].major"
          readonly="true"
          :disabled="IsChange"
          size="medium"
          style="width:82%;"
      ...
      <el-form-item label="手机号:" prop="phone">
        <el-input
          v-model="informationList[0].phone"
          :readonly="IsRead"
          size="medium"
          style="width:82%;"
        ></el-input>
      ...
      <el-form-item label="签名:" prop="signature">
        <el-input
          v-model="informationList[0].signature"
          :readonly="IsRead"
          size="medium"
          style="width:82%;"
        ></el-input>
      ...
      <el-form-item label="邮箱:" prop="mail">
        <el-input
          v-model="informationList[0].mail"
          :readonly="IsRead"
          size="medium"
          style="width:82%;"
        ></el-input>
      ...
      <div v-if="isShow1">
        <el-form-item label="生日:" prop="birthday">
          <el-input
            v-model="informationList[0].birthday.substring(0,10)"
            :readonly="IsRead"
            size="medium"
            style="width:82%;"
          ></el-input>
    ...
    <!--        修改信息对话框-->
    <el-dialog title="修改信息" :visible.sync="addDialogVisible" width="50%" center>
      <!--            内容主体区域 放置一个表单-->
      <el-form :model="addForm" ref="addFormRef" label-width="150px">
        <el-form-item label="手机号:" prop="phone">
          <el-input v-model="addForm.phone" auto-complete="off" style="width:82%;"></el-input>
        </el-form-item>
        <el-form-item label="签名:" prop="signature">
          <el-input v-model="addForm.signature" style="width:82%;"></el-input>
        </el-form-item>
        <el-form-item label="邮箱:" prop="mail">
          <el-input v-model="addForm.mail" style="width:82%;"></el-input>
        </el-form-item>
        <el-form-item label="生日:" prop="birthday">
          <!--        日历-->
          <div class="block">
