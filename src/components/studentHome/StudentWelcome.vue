    ...
    <el-dialog ref="showFormRef" :visible.sync="showDialogVisible" width="50%" center>
      ...
      <el-form :model="addForm" label-width="150px">
        ...
        <el-form-item label="社团公告标题:">
          <el-input v-model="addForm.title" readonly="true" style="width:82%;"></el-input>
        </el-form-item>
        <el-form-item label="社团公告时间:" prop="time">
          <el-date-picker type="date" v-model="addForm.time" style="width: 82%;" readonly="true"></el-date-picker>
        </el-form-item>
        <el-form-item label="社团公告内容:">
          <el-input v-model="addForm.content" readonly="true" style="width:82%;"></el-input>
        </el-form-item>
      </el-form>
      <!--            底部区域-->
  ...
  methods: {
    async getCorporationList1() {
      let result = await this.$http.post(
        this.$api.StudentGetJoinedCorporationsUrl,
        {
          query: this.query,
    ...
    drawPeople() {
      ...
      let gradeChart = this.$echarts.init(
      ...
      let majorChart = this.$echarts.init(
    ...
    async getAnnouncementList() {
      ...
      for (let i = 0; i < this.AnnouncementList.length; i++) {
        this.AnnouncementList[i].time = this.AnnouncementList[i].time.substring(
          0,
          10
        );
      }
