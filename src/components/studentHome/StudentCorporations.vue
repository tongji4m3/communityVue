  ...
  <div>
        ...
        <el-card class="myCard" :body-style="{ padding: '20px'}" shadow="hover">
          ...
          <div style="padding: 10px;">
            ...
            <div class="button">
              <el-button
                type="text"
                @click="showCorporationSummary(corporation.clubId,corporation.establishmentDate,corporation.presidentName,corporation.name)"
              >查看</el-button>
            </div>
          </div>
        </el-card>
    ...
    <el-dialog ref="showFormRef" :visible.sync="showDialogVisible" width="50%" center>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button
          type="primary"
          @click="joinNewClub(addForm.id,addForm.name,addForm.date,addForm.president)"
        >加入</el-button>
