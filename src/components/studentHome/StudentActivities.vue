...
=======
    ...
    <!--        展示活动对话框-->
    <el-dialog title="社团简介" ref="showFormRef" :visible.sync="showDialogVisible" width="50%">
      <!--            展示内容主体区域 -->
...
>>>>>>> Stashed changes
    ...
    <!--        修改活动对话框-->
    <el-dialog title="提交申请" ref="editFormRef" :visible.sync="editDialogVisible" width="50%">
