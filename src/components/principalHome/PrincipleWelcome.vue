...
<<<<<<< Updated upstream
        ...
        <!--&lt;!&ndash;                    <img class="image" width="140" height="140" src="../../assets/img/jitaxiehui.png">&ndash;&gt;-->
        <!--                    &lt;!&ndash;                <div class="image" v-html="clubForm.logo">{{clubForm.logo}}</div>&ndash;&gt;-->
        ...
        <!--                    </div>-->
        <!--&lt;!&ndash;                    <div @click="SystemNotice">系统公告：</div>&ndash;&gt;-->

        <!--                    <el-table :data="AnnouncementList" height="300"-->
